...
variety of input formats. This is illustrated by a simple comparison and
matching of experimental MS2 spectra against public spectral databases and
export of the data in a format commonly used for exchange of MS2 data.
...
parameter `FUN` to the `addProcessing` function.

```{r normalize}
#' Define a function to *normalize* the intensities. `x` is expected to be a
