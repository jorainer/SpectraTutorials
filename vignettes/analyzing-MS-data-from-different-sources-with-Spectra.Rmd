...
In this workshop we will import MS data from mzML files, compare and match the
MS2 fragment spectra for one ion (with pre-defined m/z) against MS2 spectra from
public databases (i.e. [MassBank](https://massbank.eu/MassBank/) and the Human
Metabolom Database [HMDB](https://hmdb.ca)) and export the data as an MGF
...
plotSpectraMirror(mbank_sub[best_match[1]], sps[best_match[2]],
                  tolerance = 0.2, labels = label_fun, labelPos = 2,
...
## Convenient spectra matching with `MetaboAnnotation`
