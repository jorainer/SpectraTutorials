...
Below we connect to an empty SQLite database. As detailed above, any SQL
database system could be used instead (resulting eventually in even better
performance).

```{r}
library(MsqlBackend)
library(RSQLite)
scon <- dbConnect(SQLite(), "ms_tutorial.sqlite")
```
