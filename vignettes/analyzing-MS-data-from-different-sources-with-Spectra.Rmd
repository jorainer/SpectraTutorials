...
vignette: >
  ...
  %\VignetteDepends{Spectra,mzR,RMariaDB,pheatmap,BiocStyle,CompoundDb,curl,MsBackendSql,MsBackendMassbank,RSQLite}
...
backend (defined in the `r Biocpkg()`) is used instead, but both backends
retrieve their data from a SQL database and have the same properties. Below we
list MassBank releases/versions available in Bioconductor's *AnnotationHub*.
